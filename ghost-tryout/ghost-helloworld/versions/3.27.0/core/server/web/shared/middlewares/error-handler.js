...
_private.JSONErrorRenderer = (err, req, res, next) => {
...
_private.JSONErrorRendererV2 = (err, req, res, next) => {
  // eslint-disable-line no-unused-vars
...
_private.HTMLErrorRenderer = (err, req, res, next) => {
  // eslint-disable-line no-unused-vars
  const data = {
    message: err.message,
    statusCode: err.statusCode,
...
_private.BasicErrorRenderer = (err, req, res, next) => {
  // eslint-disable-line no-unused-vars
