...
module.exports = {
  ...
  async up(options) {
    ...
    return await options.transacting('settings').whereIn('key', settingsKeys).del()
  },
  ...
  async down(options) {
    ...
    return options.transacting('settings').insert([forceI18nSetting, permalinksSetting, membersSessionSecretSetting])
  },
}
