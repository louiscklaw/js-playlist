...
Post = ghostBookshelf.Model.extend(
  {
    ...
    onSaving: async function onSaving(model, attr, options) {
      ...
      if (this.hasChanged('mobiledoc') || options.force_rerender || (!this.get('html') && (options.migrating || options.importing))) {
        try {
      ...
      if (prevTitle !== undefined && newTitle !== prevTitle && newStatus === 'draft' && !publishedAt) {
        ops.push(function updateSlug() {
          ...
          return ghostBookshelf.Model.generateSlug(Post, self.get('title'), {
            ...
            return ghostBookshelf.Model.generateSlug(Post, prevTitle, { status: 'all', transacting: options.transacting, importing: options.importing }).then(
              function prevTitleSlugGenerated(prevTitleSlug) {
