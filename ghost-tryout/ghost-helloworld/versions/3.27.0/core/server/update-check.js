...
function updateCheckResponse(response) {
  ...
  return api.settings.edit({ settings: [{ key: 'next_update_check', value: response.next_check }] }, internal).then(function () {
    /**
     * @NOTE:
     *
...
function updateCheck() {
  ...
  return api.settings
    .read(_.extend({ key: 'next_update_check' }, internal))
    .then(function then(result) {
      ...
      return updateCheckRequest().then(updateCheckResponse).catch(updateCheckError)
    })
    .catch(updateCheckError)
}
