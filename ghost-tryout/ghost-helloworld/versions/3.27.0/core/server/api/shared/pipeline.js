...
const STAGES = {
  validation: {
    ...
    input(apiUtils, apiConfig, apiImpl, frame) {
      ...
      tasks.push(function doValidation() {
        return shared.validators.handle.input(Object.assign({}, apiConfig, apiImpl.validation), apiUtils.validators.input, frame)
      })
  ...
  serialisation: {
    ...
    input(apiUtils, apiConfig, apiImpl, frame) {
      ...
      return shared.serializers.handle.input(Object.assign({ data: apiImpl.data }, apiConfig), apiUtils.serializers.input, frame)
    },
