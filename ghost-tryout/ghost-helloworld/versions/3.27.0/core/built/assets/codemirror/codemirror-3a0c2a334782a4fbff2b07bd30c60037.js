!(function (e, t) {
    ...
    return function (a, l) {
      ...
      for (var k = 0; k < c; ++k) {
        ...
        if (',' == C) d[k] = 'N'
          ...
          var S = void 0
          for (S = k + 1; S < c && '%' == d[S]; ++S);
          for (var L = (k && '!' == d[k - 1]) || (S < c && '1' == d[S]) ? '1' : 'N', T = k; T < S; ++T) d[T] = L
          k = S - 1
        }
      }
      ...
      for (var O = 0; O < c; ++O)
        if (t.test(d[O])) {
          var W = void 0
          for (W = O + 1; W < c && t.test(d[W]); ++W);
          for (var D = 'L' == (O ? d[O - 1] : s), z = D == ('L' == (W < c ? d[W] : s)) ? (D ? 'L' : 'R') : s, P = O; P < W; ++P) d[P] = z
          O = W - 1
        }
      for (var H, I = [], E = 0; E < c; )
        if (n.test(d[E])) {
          var F = E
          for (++E; E < c && n.test(d[E]); ++E);
          I.push(new o(0, F, E))
        } else {
          var R = E,
            B = I.length
          ...
          for (var j = R; j < E; )
            if (i.test(d[j])) {
              ...
              var V = j
              for (++j; j < E && i.test(d[j]); ++j);
              I.splice(B, 0, new o(2, V, j)), (R = j)
            } else ++j
          R < E && I.splice(B, 0, new o(1, R, E))
        }
      return (
        'ltr' == l &&
          (1 == I[0].level && (H = a.match(/^\s+/)) && ((I[0].from = H[0].length), I.unshift(new o(0, 0, H[0].length))),
          1 == $(I).level && (H = a.match(/\s+$/)) && (($(I).to -= H[0].length), I.push(new o(0, c - H[0].length, c)))),
        'rtl' == l ? I.reverse() : I
      )
    }
  })()
  ...
  var Oe,
    ...
    ze = 'oncopy' in (Oe = A('div')) || (Oe.setAttribute('oncopy', 'return;'), 'function' == typeof Oe.oncopy),
    Pe = null,
    He = {},
    Ie = {}
  function Ee(e, t) {
    arguments.length > 2 && (t.dependencies = Array.prototype.slice.call(arguments, 2)), (He[e] = t)
  }
  function Fe(e) {
    ...
    (Ue.prototype.column = function () {
      return (
        this.lastColumnPos < this.start &&
          ((this.lastColumnValue = F(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)), (this.lastColumnPos = this.start)),
  ...
  function ht(e, t, r) {
    ...
    var o = (function (e, t, r) {
      ...
      a = o > n.first && qe(n, o - 1).stateAfter,
      l = a ? ct.fromSaved(n, a, o) : new ct(n, Ge(n.mode), o)
    return (
  ...
  function Tt(e, t) {
    ...
    var r = Qe(e, t.from.line) && qe(e, t.from.line).markedSpans,
      n = Qe(e, t.to.line) && qe(e, t.to.line).markedSpans
    if (!r && !n) return null
    var i = t.from.ch,
      o = t.to.ch,
      a = 0 == tt(t.from, t.to),
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (null == o.from || (a.inclusiveLeft ? o.from <= t : o.from < t) || (o.from == t && 'bookmark' == a.type && (!r || !o.marker.insertLeft))) {
              ...
              ;(n || (n = [])).push(new Ct(a, o.from, l ? null : o.to))
            }
          }
        return n
      })(r, i, a),
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (null == o.to || (a.inclusiveRight ? o.to >= t : o.to > t) || (o.from == t && 'bookmark' == a.type && (!r || o.marker.insertLeft))) {
              ...
              ;(n || (n = [])).push(new Ct(a, l ? null : o.from - t, null == o.to ? null : o.to - t))
            }
          }
        return n
      })(n, o, a),
    ...
    if (s)
      for (var p = 0; p < s.length; ++p) {
        var g = s[p]
        null != g.to && (g.to += c),
          null == g.from ? St(l, g.marker) || ((g.from = c), u && (l || (l = [])).push(g)) : ((g.from += c), u && (l || (l = [])).push(g))
      }
  ...
  function zt(e, t) {
    var r,
      n = kt && e.markedSpans
    if (n)
      for (var i = void 0, o = 0; o < n.length; ++o) (i = n[o]).marker.collapsed && null == (t ? i.from : i.to) && (!r || Dt(r, i.marker) < 0) && (r = i.marker)
    return r
  }
  function Pt(e) {
    return zt(e, !0)
      ...
      for (var l = 0; l < a.length; ++l) {
        ...
        if (s.marker.collapsed) {
          var u = s.marker.find(0),
            ...
            d = tt(u.to, n) || Wt(s.marker) - Wt(i)
          if (
            !((c >= 0 && d <= 0) || (c <= 0 && d >= 0)) &&
            ((c <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? tt(u.to, r) >= 0 : tt(u.to, r) > 0)) ||
              (c >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? tt(u.from, n) <= 0 : tt(u.from, n) < 0)))
          )
            return !0
        }
      }
  ...
  function Zt(e, t) {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      ;(n.pos = 0),
        (n.addToken = Jt),
        Ae(e.display.measure) && (a = ue(o, e.doc.direction)) && (n.addToken = er(n.addToken, a)),
        (n.map = []),
        rr(o, n, ft(e, o, t != e.display.externalMeasured && Ye(o))),
        o.styleClasses &&
          (o.styleClasses.bgClass && (n.bgClass = P(o.styleClasses.bgClass, n.bgClass || '')),
          o.styleClasses.textClass && (n.textClass = P(o.styleClasses.textClass, n.textClass || ''))),
        0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Ne(e.display.measure))),
        0 == i
    ...
    return pe(e, 'renderLine', e, t.line, n.pre), n.pre.className && (n.textClass = P(n.pre.className, n.textClass || '')), n
  }
  function Qt(e) {
        ...
        for (var h = 0; ; ) {
          ...
          if ('\t' == p[0]) {
            var y = e.cm.options.tabSize,
              b = y - (e.col % y)
            ;(v = u.appendChild(A('span', _(b), 'cm-tab'))).setAttribute('role', 'presentation'), v.setAttribute('cm-text', '\t'), (e.col += b)
          } else
            '\r' == p[0] || '\n' == p[0]
              ? ((v = u.appendChild(A('span', '\r' == p[0] ? '␍' : '␤', 'cm-invalidchar'))).setAttribute('cm-text', p[0]), (e.col += 1))
  ...
  function rr(e, t, r) {
    var n = e.markedSpans,
      ...
      o = 0
    if (n)
      for (var a, l, s, u, c, d, f, h = i.length, p = 0, g = 1, m = '', v = 0; ; ) {
        if (v == p) {
  ...
  function nr(e, t, r) {
    ;(this.line = t),
      ...
      (this.size = this.rest ? Ye($(this.rest)) - r + 1 : 1),
  ...
  function hr(e, t) {
    !(function (e, t) {
      ...
      t.line.wrapClass ? (cr(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = '')
  ...
  function mr(e, t, r, n) {
    var i = dr(e, t)
    return (
      (t.text = t.node = i.pre), i.bgClass && (t.bgClass = i.bgClass), i.textClass && (t.textClass = i.textClass), hr(e, t), pr(e, t, r, n), vr(e, t, n), t.node
    )
  }
  function vr(e, t, r) {
  ...
  function yr(e, t, r, n, i) {
    if (t.widgets)
      for (var o = cr(r), a = 0, l = t.widgets; a < l.length; ++a) {
        var s = l[a],
          u = A('div', [s.node], 'CodeMirror-linewidget')
        s.handleMouseEvents || u.setAttribute('cm-ignore-events', 'true'),
          br(s, u, r, n),
          e.display.input.setUneditable(u),
          i && s.above ? o.insertBefore(u, r.gutter || r.text) : o.appendChild(u),
          lr(s, 'redraw')
      }
  }
  function br(e, t, r, n) {
  ...
  function Wr(e, t) {
    var r = Ye(t),
      n = Or(e, r)
    n && !n.text ? (n = null) : n && n.changes && (ur(e, n, r, on(e)), (e.curOp.forceUpdate = !0)),
      n ||
        (n = (function (e, t) {
          var r = Ye((t = Ft(t))),
          ...
          (o = (function (e, t, r, n) {
            ...
            if (3 == s.nodeType) {
              for (var f = 0; f < 4; f++) {
                ...
                if (
                  (i = a && l < 9 && 0 == u && c == o.coverEnd - o.coverStart ? s.parentNode.getBoundingClientRect() : Ir(L(s, u, c).getClientRects(), n))
                    .left ||
                  i.right ||
                  0 == u
                )
              ...
              var h
              u > 0 && (d = n = 'right'),
                (i = e.options.lineWrapping && (h = s.getClientRects()).length > 1 ? h['right' == n ? h.length - 1 : 0] : s.getBoundingClientRect())
            }
            ...
            var w = b ? y[b - 1] : 0,
              x = y[b],
              k = { left: ('right' == d ? i.right : i.left) - t.rect.left, right: ('left' == d ? i.left : i.right) - t.rect.left, top: w, bottom: x }
  ...
  function Hr(e, t, r) {
    for (var n, i, o, a, l, s, u = 0; u < e.length; u += 3)
      if (
        ...
        if (((n = e[u + 2]), l == s && r == (n.insertLeft ? 'left' : 'right') && (a = r), 'left' == r && 0 == i))
          for (; u && e[u - 2] == e[u - 3] && e[u - 1].insertLeft; ) (n = e[2 + (u -= 3)]), (a = 'left')
  ...
  function Ur(e, t, r, n, i) {
    return n || (n = qe(e.doc, t.line)), Kr(e, n, Ar(e, n, t.ch, i), r)
  }
  function qr(e, t, r, n, i, o) {
    ...
    var l = ue(n, e.doc.direction),
      s = t.ch,
      u = t.sticky
    if ((s >= n.text.length ? ((s = n.text.length), (u = 'before')) : s <= 0 && ((s = 0), (u = 'after')), !l))
  ...
  function Zr(e, t, r, n) {
    return r || (r = Wr(e, t)), Yr(e, t, r, Kr(e, t, Dr(e, r, n), 'line').top)
  }
  function Qr(e, t, r, n) {
  ...
  function Jr(e, t, r, n, i) {
    ...
    if (g) {
      ...
      u || (m != s && m != l) || m++,
        (h = 0 == m ? 'after' : m == t.text.length ? 'before' : Dr(e, o, m - (u ? 1 : 0)).bottom + a <= i == u ? 'after' : 'before')
  ...
  function en(e, t, r, n, i, o, a) {
    ...
    if (l > 0) {
      var u = 1 != s.level,
        c = qr(e, et(r, u ? s.from : s.to, u ? 'after' : 'before'), 'line', t, n)
  ...
  function tn(e, t, r, n, i, o, a) {
    ...
    for (var c = null, d = null, f = 0; f < i.length; f++) {
      var h = i[f]
      if (!(h.from >= u || h.to <= s)) {
        var p = Dr(e, n, 1 != h.level ? Math.min(u, h.to) - 1 : Math.max(s, h.from)).right,
          g = p < o ? o - p + 1e9 : p - o
        ;(!c || d > g) && ((c = h), (d = g))
      }
    }
  ...
  function vn(e, t) {
    void 0 === t && (t = !0)
    for (
      var r = e.doc, n = {}, i = (n.cursors = document.createDocumentFragment()), o = (n.selection = document.createDocumentFragment()), a = 0;
      ...
      if (t || a != r.sel.primIndex) {
        ...
        if (!(l.from().line >= e.display.viewTo || l.to().line < e.display.viewFrom)) {
          var s = l.empty()
          ;(s || e.options.showCursorWhenSelecting) && yn(e, l.head, i), s || wn(e, l, o)
        }
      }
    return n
  }
  function yn(e, t, r) {
    ...
    if (
      ((i.style.left = n.left + 'px'), (i.style.top = n.top + 'px'), (i.style.height = Math.max(0, n.bottom - n.top) * e.options.cursorHeight + 'px'), n.other)
    ) {
  ...
  function wn(e, t, r) {
    ...
    function d(t, r, n) {
      ...
      return (
        (function (e, t, r, n) {
          ...
          if (y.top - v.top <= 3) {
            var C = (u ? w : b) && k,
              S = (u ? b : w) && x ? l : (m ? v : y).left,
              L = C ? s : (m ? y : v).right
            c(S, v.top, L - S, v.bottom)
          } else {
            var T, M, N, A
            m
              ? ((T = u && b && x ? l : v.left), (M = u ? s : p(e, i, 'before')), (N = u ? l : p(t, i, 'after')), (A = u && w && k ? s : y.right))
              : ((T = u ? p(e, i, 'before') : l), (M = !u && b && x ? s : v.right), (N = !u && w && k ? l : y.left), (A = u ? p(t, i, 'after') : s)),
    ...
    if (f.line == h.line) d(f.line, f.ch, h.ch)
      ...
      var p = qe(i, f.line),
        g = qe(i, h.line),
        m = Ft(p) == Ft(g),
        v = d(f.line, f.ch, m ? p.text.length + 1 : null).end,
        y = d(h.line, m ? 0 : null, h.ch).start
      m && (v.top < y.top - 2 ? (c(v.right, v.top, null, v.bottom), c(l, y.top, y.left, y.bottom)) : c(v.right, v.top, y.left - v.right, v.bottom)),
        v.bottom < y.top && c(l, v.bottom, null, y.top)
    }
    r.appendChild(o)
  }
  ...
  function Tn(e) {
    for (var t = e.display, r = t.lineDiv.offsetTop, n = 0; n < t.view.length; n++) {
      ...
      if (!i.hidden) {
        ...
        if ((f > 0.005 || f < -0.005) && (Xe(i.line, s), Mn(i.line), i.rest)) for (var h = 0; h < i.rest.length; h++) Mn(i.rest[h])
  ...
  function Nn(e, t, r) {
    ...
    if (r && r.ensure) {
      var l = r.ensure.from.line,
        s = r.ensure.to.line
      l < o
        ? ((o = l), (a = Ze(t, Kt(qe(t, l)) + e.wrapper.clientHeight)))
        : Math.min(s, t.lastLine()) >= a && ((o = Ze(t, Kt(qe(t, s)) - e.wrapper.clientHeight)), (a = s))
    }
  ...
  function Dn(e, t, r) {
    ;(null == t && null == r) || zn(e), null != t && (e.curOp.scrollLeft = t), null != r && (e.curOp.scrollTop = r)
  }
  function zn(e) {
  ...
  function Hn(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 || (r || si(e, { top: t }), In(e, t, !0), r && si(e), ni(e, 100))
  }
  function In(e, t, r) {
  ...
  ;(Rn.prototype.update = function (e) {
    ...
    return (
      !this.checkedZeroWidth && e.clientHeight > 0 && (0 == n && this.zeroWidthHack(), (this.checkedZeroWidth = !0)), { right: r ? n : 0, bottom: t ? n : 0 }
    )
  }),
    ...
    (Rn.prototype.enableZeroWidthBar = function (e, t, r) {
      ;(e.style.pointerEvents = 'auto'),
        t.set(1e3, function n() {
          ...
          ;('vert' == r ? document.elementFromPoint(i.right - 1, (i.top + i.bottom) / 2) : document.elementFromPoint((i.right + i.left) / 2, i.bottom - 1)) != e
  ...
  function jn(e, t) {
    ...
    for (var i = 0; (i < 4 && r != e.display.barWidth) || n != e.display.barHeight; i++)
      r != e.display.barWidth && e.options.lineWrapping && Tn(e), Vn(e, Fn(e)), (r = e.display.barWidth), (n = e.display.barHeight)
  }
  function Vn(e, t) {
    var r = e.display,
    ...
    ;(r.sizer.style.paddingRight = (r.barWidth = n.right) + 'px'),
      ...
      n.right && n.bottom
        ? ((r.scrollbarFiller.style.display = 'block'), (r.scrollbarFiller.style.height = n.bottom + 'px'), (r.scrollbarFiller.style.width = n.right + 'px'))
  ...
  function Gn(e) {
    e.display.scrollbars && (e.display.scrollbars.clear(), e.display.scrollbars.addClass && T(e.display.wrapper, e.display.scrollbars.addClass)),
      (e.display.scrollbars = new Kn[e.options.scrollbarStyle](
        function (t) {
  ...
  function qn(e) {
    ...
    ;(e.curOp = {
      ...
      (t = e.curOp),
      or ? or.ops.push(t) : (t.ownsGroup = or = { ops: [t], delayedCallbacks: [] })
  }
  function _n(e) {
    var t = e.curOp
    t &&
  ...
  function Yn(e) {
    ...
    e.updatedDisplay && Tn(t),
      ...
      r.maxLineChanged &&
        ...
        ((e.adjustWidthTo = Ar(t, r.maxLine, r.maxLine.text.length).left + 3),
        (t.display.sizerWidth = e.adjustWidthTo),
        (e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Lr(t) + t.display.barWidth)),
        (e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Tr(t)))),
  ...
  function Qn(e) {
    ...
    e.updatedDisplay && li(t, e.update),
      ...
      null != e.scrollTop && In(t, e.scrollTop, e.forceScroll),
      null != e.scrollLeft && En(t, e.scrollLeft, !0, !0),
      e.scrollToPos &&
        (function (e, t) {
          if (!ge(e, 'scrollCursorIntoView')) {
            var r = e.display,
              ...
              i = null
            if (
              (t.top + n.top < 0 ? (i = !0) : t.bottom + n.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !p)
            ) {
              var o = A(
                'div',
                '​',
                null,
                'position: absolute;\n                         top: ' +
                  (t.top - r.viewOffset - kr(e.display)) +
                  'px;\n                         height: ' +
          ...
          (function (e, t, r, n) {
            ...
            null == n && (n = 0),
              e.options.lineWrapping ||
                t != r ||
                (r = 'before' == (t = t.ch ? et(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after') : t).sticky ? et(t.line, t.ch + 1, 'before') : t)
            for (var o = 0; o < 5; o++) {
              var a = !1,
                l = qr(e, t),
                s = r && r != t ? qr(e, r) : l,
                ...
                d = e.doc.scrollLeft
              if (
                (null != u.scrollTop && (Hn(e, u.scrollTop), Math.abs(e.doc.scrollTop - c) > 1 && (a = !0)),
                null != u.scrollLeft && (En(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - d) > 1 && (a = !0)),
                !a)
              )
                break
            }
    ...
    if (!(t.highlightFrontier >= e.display.viewTo)) {
      ...
      t.iter(n.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
        if (n.line >= e.display.viewFrom) {
          ...
          for (
            var d = !a || a.length != o.styles.length || (u != c && (!u || !c || u.bgClass != c.bgClass || u.textClass != c.textClass)), f = 0;
            !d && f < a.length;
            ++f
          )
            d = a[f] != o.styles[f]
  ...
  function ai(e, t) {
    ...
    !(function (e, t, r) {
      ...
      0 == n.view.length || t >= n.viewTo || r <= n.viewFrom
        ...
        : (n.viewFrom > t ? (n.view = ir(e, t, n.viewFrom).concat(n.view)) : n.viewFrom < t && (n.view = n.view.slice(cn(e, t))),
          (n.viewFrom = t),
          n.viewTo < r ? (n.view = n.view.concat(ir(e, n.viewTo, r))) : n.viewTo > r && (n.view = n.view.slice(0, cn(e, r)))),
        (n.viewTo = r)
    })(e, o, a),
      (r.viewOffset = Kt(qe(e.doc, r.viewFrom))),
    ...
    return (
      ...
      (function (e, t, r) {
        ...
        for (var u = n.view, c = n.viewFrom, d = 0; d < u.length; d++) {
          ...
          if (f.hidden);
            ...
            f.changes && (B(f.changes, 'gutter') > -1 && (h = !1), ur(e, f, c, r)),
              h && (M(f.lineNumber), f.lineNumber.appendChild(document.createTextNode(Je(e.options, c)))),
      ...
      l && ((r.lastWrapHeight = t.wrapperHeight), (r.lastWrapWidth = t.wrapperWidth), ni(e, 400)),
  ...
  function li(e, t) {
    for (
      ...
      ((n && e.options.lineWrapping && t.oldDisplayWidth != Tr(e)) ||
        (r && null != r.top && (r = { top: Math.min(e.doc.height + Cr(e.display) - Mr(e), r.top) }),
  ...
  function ci(e, t) {
    ;(e.display.sizer.style.minHeight = t.docHeight + 'px'),
      ...
      (e.display.gutters.style.height = t.docHeight + e.display.barHeight + Lr(e) + 'px')
  }
  function di(e) {
    var t = e.display,
      r = t.view
  ...
  function xi(e, t) {
    ...
    if ((i && u) || (o && c)) {
      ...
      if (i && !r && !d && null != yi)
        return (
          o && c && Hn(e, Math.max(0, l.scrollTop + o * yi)), En(e, Math.max(0, l.scrollLeft + i * yi)), (!o || (o && c)) && be(t), void (a.wheelStartX = null)
        )
      if (o && null != yi) {
        var g = o * yi,
          m = e.doc.scrollTop,
  ...
  a ? (yi = -0.53) : r ? (yi = 15) : c ? (yi = -0.7) : f && (yi = -1 / 3)
  var ki = function (e, t) {
  ...
  function Oi(e) {
    ;(e.doc.mode = Re(e.options, e.doc.modeOption)), Wi(e)
  }
  function Wi(e) {
  ...
  function zi(e, t, r, n) {
    ...
    if (t.full) e.insert(0, a(0, u.length)), e.remove(u.length, e.size - u.length)
      ...
      if (1 == u.length) o(c, c.text.slice(0, l.ch) + f + c.text.slice(s.ch), h)
      else {
  ...
  function Bi(e, t, r, n) {
    ...
    if (
      ...
      (a = $(o.changes)), 0 == tt(t.from, t.to) && 0 == tt(t.from, a.to) ? (a.to = Ti(t)) : o.changes.push(Fi(e, t))
    else {
      var s = $(i.done)
      for ((s && s.ranges) || ji(e.sel, i.done), o = { changes: [Fi(e, t)], generation: i.generation }, i.done.push(o); i.done.length > i.undoDepth; )
      ...
      if (o.ranges) n.push(r ? ki.prototype.deepCopy.call(o) : o)
        ...
        for (var s = 0; s < a.length; ++s) {
          ...
          if ((l.push({ from: u.from, to: u.to, text: u.text }), t))
            for (var d in u) (c = d.match(/^spans_(\d+)$/)) && B(t, Number(c[1])) > -1 && (($(l)[d] = u[d]), delete u[d])
        }
      }
    }
    return n
  ...
  function _i(e, t, r, n, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)), Qi(e, new ki([qi(e.sel.primary(), t, r, i)], 0), n)
  }
  function $i(e, t, r) {
  ...
  function ro(e, t, r, n) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      var a = t.ranges[o],
        ...
        s = io(e, a.anchor, l && l.anchor, r, n),
        u = io(e, a.head, l && l.head, r, n)
      ;(i || s != a.anchor || u != a.head) && (i || (i = t.ranges.slice(0, o)), (i[o] = new Ci(s, u)))
    }
        ...
        if ((null == l.from || (u ? l.from <= t.ch : l.from < t.ch)) && (null == l.to || (c ? l.to >= t.ch : l.to > t.ch))) {
          ...
          if (r) {
            var d = s.find(n < 0 ? 1 : -1),
              f = void 0
            if (((n < 0 ? c : u) && (d = oo(e, d, -n, d && d.line == t.line ? o : null)), d && d.line == t.line && (f = tt(d, r)) && (n < 0 ? f < 0 : f > 0)))
              return no(e, d, t, n, i)
          }
            ...
            for (var a = n[o], l = a.find(0), s = 0; s < i.length; ++s) {
              ...
              if (!(tt(u.to, l.from) < 0 || tt(u.from, l.to) > 0)) {
                ...
                ;(d < 0 || (!a.inclusiveLeft && !d)) && c.push({ from: u.from, to: l.from }),
                  (f > 0 || (!a.inclusiveRight && !f)) && c.push({ from: l.to, to: u.to }),
                  i.splice.apply(i, c),
                  (s += c.length - 3)
              }
            }
  ...
  function uo(e, t) {
    if (1 != t.text.length || '' != t.text[0] || 0 != tt(t.from, t.to)) {
      ...
      var n = []
      Pi(e, function (e, r) {
        r || -1 != B(n, e.history) || (vo(e.history, t), n.push(e.history)), ho(e, t, null, Tt(e, t))
      })
    }
  }
  function co(e, t, r) {
    ...
    if (!n || r) {
      for (
        ...
        u < l.length && ((i = l[u]), r ? !i.ranges || i.equals(e.sel) : i.ranges);
        u++
      );
      if (u != l.length) {
        ...
        for (
          var d = ve(e, 'beforeChange') || (e.cm && ve(e.cm, 'beforeChange')),
            f = function (r) {
              ...
              var a = []
              Pi(e, function (e, t) {
                t || -1 != B(a, e.history) || (vo(e.history, n), a.push(e.history)), ho(e, n, null, Gi(e, n))
              })
            },
  ...
  function ho(e, t, r, n) {
    ...
    if (t.to.line < e.first) fo(e, t.text.length - 1 - (t.to.line - t.from.line))
      ...
      var o = e.lastLine()
      t.to.line > o && (t = { from: t.from, to: et(o, qe(e, o).text.length), text: [t.text[0]], origin: t.origin }),
  ...
  function ko(e, t, r) {
    Kt(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) && On(e, r)
  }
  ;(xo.prototype.clear = function () {
    ...
    (xo.prototype.changed = function () {
      ...
      var i = wr(this) - t
      i &&
        (jt(this.doc, n) || Xe(n, n.height + i),
        r &&
          Jn(r, function () {
            ;(r.curOp.forceUpdate = !0), ko(r, n, i), lr(r, 'lineWidgetChanged', r, e, Ye(n))
          }))
    }),
    ye(xo)
  var Co = 0,
  ...
  function Lo(e, t, r, n, i) {
    ...
    if (
      ...
      if (Et(e, t.line, t, r, o) || (t.line != r.line && Et(e, r.line, t, r, o)))
    ...
    if (
      (e.iter(s, r.line + 1, function (e) {
        u && o.collapsed && !u.options.lineWrapping && Ft(e) == u.display.maxLine && (l = !0),
          o.collapsed && s != t.line && Xe(e, 0),
          (function (e, t) {
            ;(e.markedSpans = e.markedSpans ? e.markedSpans.concat([t]) : [t]), t.marker.attachLine(e)
          })(e, new Ct(o, s == t.line ? t.ch : null, s == r.line ? r.ch : null)),
          ++s
      }),
      o.collapsed &&
  ...
  ;(So.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
        ...
        e && !this.collapsed ? fn(e, Ye(a), 'text') : e && (null != l.to && (i = Ye(a)), null != l.from && (n = Ye(a))),
          (a.markedSpans = Lt(a.markedSpans, l)),
          null == l.from && this.collapsed && !jt(this.doc, a) && e && Xe(a, rn(e.display))
      }
  ...
  ;(To.prototype.clear = function () {
    ...
    ye(To)
  var Ao = 0,
    Oo = function (e, t, r, n, i) {
      if (!(this instanceof Oo)) return new Oo(e, t, r, n, i)
      null == r && (r = 0),
        wo.call(this, [new bo([new qt('', null)])]),
        (this.first = r),
  ...
  ;(Oo.prototype = Z(wo.prototype, {
    ...
    setValue: ri(function (e) {
      ...
      so(this, { from: t, to: et(r, qe(this, r).text.length), text: this.splitLines(e), origin: 'setValue', full: !0 }, !0),
        this.cm && Dn(this.cm, 0, 0),
        Qi(this, Li(t), V)
    }),
    replaceRange: function (e, t, r, n) {
      po(this, e, (t = lt(this, t)), (r = r ? lt(this, r) : t), n)
    },
    ...
    extendSelection: ri(function (e, t, r) {
      _i(this, lt(this, e), t && lt(this, t), r)
    }),
    ...
    addLineWidget: ri(function (e, t, r) {
      return (function (e, t, r, n) {
        ...
        return (
          ...
          o && lr(o, 'lineWidgetAdded', o, i, 'number' == typeof t ? t : Ye(t)),
          i
        )
      })(this, e, t, r)
    }),
    ...
    findMarksAt: function (e) {
      var t = [],
        r = qe(this, (e = lt(this, e)).line).markedSpans
      if (r)
        for (var n = 0; n < r.length; ++n) {
          var i = r[n]
      ...
      if ((e instanceof Sa && (e = e.doc), this.linked))
        for (var t = 0; t < this.linked.length; ++t)
          if (this.linked[t].doc == e) {
            this.linked.splice(t, 1), e.unlinkDoc(this), No(Mo(this))
            break
          }
      ...
      if (r && !t.isReadOnly())
        if (n && n.length && window.FileReader && window.File)
          ...
          try {
            ...
            if (c) {
              var d
              if ((t.state.draggingText && !t.state.draggingText.copy && (d = t.listSelections()), Ji(t.doc, Li(r, r)), d))
                for (var f = 0; f < d.length; ++f) po(t.doc, '', d[f].anchor, d[f].head, 'drag')
  ...
  function qo(e, t, r) {
    ...
    return (
      ...
      (k ? t.ctrlKey : t.metaKey) && 'Cmd' != n && (e = 'Cmd-' + e),
    ...
    return (
      ...
      (t.shiftKey && !e.state.keySeq
        ? ia(e, 'Shift-' + r, t, function (t) {
          ...
          ia(e, r, t, function (t) {
            if ('string' == typeof t ? /^go[A-Z]/.test(t) : t.motion) return ra(e, t)
          })
        : ia(e, r, t, function (t) {
            return ra(e, t)
          }))
  ...
  function sa(e) {
    ...
    if (((t.curOp.focus = D()), !ge(t, e))) {
      ...
      var n = aa(t, e)
      d && ((la = n ? r : null), n || 88 != r || ze || !(y ? e.metaKey : e.ctrlKey) || t.replaceSelection('', null, 'cut')),
        18 != r ||
          /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) ||
          (function (e) {
            var t = e.display.lineDiv
            function r(e) {
              ;(18 != e.keyCode && e.altKey) || (T(t, 'CodeMirror-crosshair'), he(document, 'keyup', r), he(document, 'mouseover', r))
            }
            z(t, 'CodeMirror-crosshair'), de(document, 'keyup', r), de(document, 'mouseover', r)
          })(t)
    }
  }
  function ua(e) {
          ...
          o = n
            ? (function (e, t) {
                ...
                return fa && fa.compare(r, e, t)
                  ? ((da = fa = null), 'triple')
                  : da && da.compare(r, e, t)
                  ? ((fa = new ha(r, e, t)), (da = null), 'double')
                  : ((da = new ha(r, e, t)), (fa = null), 'single')
              })(n, i)
            : 'single'
        window.focus(),
          ...
          (n &&
            (function (e, t, r, n, i) {
              ...
              return (
                ...
                ia(e, qo((o = (1 == t ? 'Left' : 2 == t ? 'Middle' : 'Right') + o), i), i, function (t) {
                ...
                ? (function (e, t, r, n) {
                    ...
                    (tt(i.to(), t) > 0 || t.xRel < 0)
                      ...
                      : (function (e, t, r, n) {
                          ...
                          if (
                            (n.addNew && !n.extend
                              ? ((l = o.sel.contains(r)), (a = l > -1 ? u[l] : new Ci(r, r)))
                              : ((a = o.sel.primary()), (l = o.sel.primIndex)),
                            'rectangle' == n.unit)
                          )
                            n.addNew || (a = new Ci(r, r)), (r = un(e, t, !0, !0)), (l = -1)
                          else {
                            var c = ga(e, r, n.unit)
                            ...
                            if (0 != tt(d, t))
                              if (((d = t), 'rectangle' == n.unit)) {
                                for (
                                  var i = [],
                                    u = e.options.tabSize,
                                    c = F(qe(o, r.line).text, r.ch, u),
                                    f = F(qe(o, t.line).text, t.ch, u),
                                    h = Math.min(c, f),
                                    p = Math.max(c, f),
                          ...
                          var m = ei(e, function (t) {
                                    ...
                                    if (l)
                                      if (0 != tt(l, d)) {
                                        ...
                                        u &&
                                          setTimeout(
                                            ei(e, function () {
                                              p == a && ((i.scroller.scrollTop += u), t(r))
                                            }),
                                            50,
                                          )
                                      }
                            ...
                            v = ei(e, g)
                          ;(e.state.selectingText = v), de(i.wrapper.ownerDocument, 'mousemove', m), de(i.wrapper.ownerDocument, 'mouseup', v)
                        })(e, n, t, o)
                  })(t, n, o, e)
                : Ce(e) == r.scroller && be(e)
              : 2 == i
              ? (n && _i(t.doc, n),
                setTimeout(function () {
                  return r.input.focus()
                }, 20))
              : 3 == i && (C ? t.display.input.onContextMenu(e) : Cn(t)))
      }
  }
  function ga(e, t, r) {
  ...
  ha.prototype.compare = function (e, t, r) {
  ...
  function Ca(e) {
    e.options.lineWrapping
      ? (z(e.display.wrapper, 'CodeMirror-wrap'), (e.display.sizer.style.minWidth = ''), (e.display.sizerWidth = null))
  ...
  function Sa(e, t) {
    ...
    (function (e) {
      var t = e.display
      de(t.scroller, 'mousedown', ei(e, pa)),
        de(
          t.scroller,
          'dblclick',
          a && l < 11
        ...
        de(t.scroller, 'contextmenu', function (t) {
          return (function (e, t) {
            xr(e.display, t) ||
              (function (e, t) {
                return !!ve(e, 'gutterContextMenu') && ma(e, t, 'gutterContextMenu', !1)
              })(e, t) ||
              ge(e, t, 'contextmenu') ||
              C ||
      ...
      de(t.scroller, 'touchstart', function (i) {
          ...
          if (n && !xr(t, r) && null != n.left && !n.moved && new Date() - n.start < 300) {
            ...
            ;(a =
              !n.prev || o(n, n.prev)
                ...
                ? e.findWordAt(l)
                : new Ci(et(l.line, 0), lt(e.doc, et(l.line + 1, 0)))),
        ...
        de(t.scroller, 'scroll', function () {
          t.scroller.clientHeight && (Hn(e, t.scroller.scrollTop), En(e, t.scroller.scrollLeft, !0), pe(e, 'scroll', e))
        }),
          ...
          start: function (t) {
            return (function (e, t) {
              if (a && (!e.state.draggingText || +new Date() - Wo < 100)) ke(t)
                ...
                !ge(e, t) &&
                !xr(e.display, t) &&
                (t.dataTransfer.setData('Text', e.getSelection()), (t.dataTransfer.effectAllowed = 'copyMove'), t.dataTransfer.setDragImage && !f)
              ) {
                ...
                ;(r.src = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='),
                  d && ((r.width = r.height = 1), e.display.wrapper.appendChild(r), (r._top = r.offsetTop)),
      ...
      de(s, 'keyup', function (t) {
        ...
        de(s, 'keydown', ei(e, sa)),
        de(s, 'keypress', ei(e, ca)),
    ...
    Hi(this, n),
    (t.autofocus && !v) || this.hasFocus() ? setTimeout(I(Sn, this), 20) : Ln(this),
    xa))
      xa.hasOwnProperty(u) && xa[u](r, t[u], ba)
  ...
  function Ta(e, t, r, n) {
    ...
    'prev' == r
      ? (u = t > o.first ? F(qe(o, t - 1).text, null, a) : 0)
      : 'add' == r
    ...
    for (var d = e.curOp.updateInput, f = n.ranges.length - 1; f >= 0; f--) {
      ...
      h.empty() &&
        (r && r > 0
          ? (p = et(p.line, p.ch - r))
          : e.state.overwrite && !l
          ? (g = et(g.line, Math.min(qe(o, g.line).text.length, g.ch + $(s).length)))
  ...
  function Ha(e, t, r, n, i) {
      ...
      if (
        ...
        (o = i
          ? (function (e, t, r, n) {
              ...
              var l,
                s = function (e, r) {
                  return Yo(t, e instanceof et ? e.ch : e, r)
                },
                u = function (r) {
                  return e.options.lineWrapping ? ((l = l || Wr(e, t)), Zr(e, t, l, r)) : { begin: 0, end: t.text.length }
                },
    ...
    if ('char' == n) s()
      ...
      for (var u = null, c = 'group' == n, d = e.cm && e.cm.getHelper(t, 'wordChars'), f = !0; !(r < 0) || s(!f); f = !1) {
  ...
  function Ia(e, t, r, n) {
    ...
    if ('page' == n) {
      var s = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight),
        u = Math.max(s - 0.5 * rn(e.display), 3)
  ...
  ;(Ea.prototype.init = function (e) {
    ...
    za(i, n.options.spellcheck, n.options.autocorrect, n.options.autocapitalize),
      ...
      if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
        ...
        if (!this.composing) {
          ...
          r &&
            n &&
            Jn(t, function () {
              Qi(t.doc, Li(r, n), V), (r.bad || n.bad) && (t.curOp.selectionChanged = !0)
            })
        }
      }
    }),
    (Ea.prototype.pollContent = function () {
      ...
      var e,
        ...
        l = o.to()
      if (
        (0 == a.ch && a.line > n.firstLine() && (a = et(a.line - 1, qe(n.doc, a.line - 1).length)),
        l.ch == qe(n.doc, l.line).text.length && l.line < n.lastLine() && (l = et(l.line + 1, 0)),
        a.line < i.viewFrom || l.line > i.viewTo - 1)
      )
        return !1
      a.line == i.viewFrom || 0 == (e = cn(n, a.line))
      ...
      for (
        var d = n.doc.splitLines(
            (function (e, t, r, n, i) {
              ...
              function d(t) {
                if (1 == t.nodeType) {
                  ...
                  p && u()
                  for (var g = 0; g < t.childNodes.length; g++) d(t.childNodes[g])
          ...
          f = _e(n.doc, et(t, 0), et(s, qe(n.doc, s).text.length));
      ...
      for (
        var y = $(d), b = $(f), w = Math.min(y.length - (1 == d.length ? h : 0), b.length - (1 == f.length ? h : 0));
    ...
    (Ea.prototype.onKeyPress = function (e) {
      0 == e.charCode ||
        this.composing ||
        (e.preventDefault(), this.cm.isReadOnly() || ei(this.cm, Aa)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }),
  ...
  ;(Va.prototype.init = function (e) {
    ...
    e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
      ...
      de(i, 'paste', function (e) {
        ge(n, e) || Oa(e, n) || ((n.state.pasteIncoming = +new Date()), r.fastPoll())
      }),
      de(i, 'cut', o),
      de(i, 'copy', o),
    ...
    (Va.prototype.poll = function () {
      var e = this,
        ...
        r = this.textarea,
        n = this.prevInput
      if (this.contextMenuPending || !t.state.focused || (De(r) && !n && !this.composing) || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
        return !1
      var i = r.value
      ...
      return (
        Jn(t, function () {
          Aa(t, i.slice(s), n.length - s, null, e.composing ? '*compose' : null),
            i.length > 1e3 || i.indexOf('\n') > -1 ? (r.value = e.prevInput = '') : (e.prevInput = i),
            e.composing &&
              (e.composing.range.clear(), (e.composing.range = t.markText(e.composing.start, t.getCursor('to'), { className: 'CodeMirror-composing' })))
        }),
        !0
      )
    }),
    ...
    (Va.prototype.onContextMenu = function (e) {
      ...
      if (o && !d) {
        ...
        if (
          ...
          ke(e)
          var g = function () {
            he(window, 'mouseup', g), setTimeout(v, 20)
          }
          de(window, 'mouseup', g)
      ...
      function v() {
        if (
          ...
          (i.style.cssText = f),
          a && l < 9 && n.scrollbars.setScrollTop((n.scroller.scrollTop = u)),
    ...
    (function (e) {
      ...
      ;(e.defineOption = r),
        ...
        r('specialChars', /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b-\u200f\u2028\u2029\ufeff\ufff9-\ufffc]/g, function (e, t, r) {
          ;(e.state.specialChars = new RegExp(t.source + (t.test('\t') ? '' : '|\t'), 'g')), r != ba && e.refresh()
        }),
        r(
        ...
        r(
          ...
          [],
          function (e, t) {
            ;(e.display.gutterSpecs = hi(t, e.options.lineNumbers)), gi(e)
          },
          !0,
        ),
        r(
        ...
        r(
          ...
          !1,
          function (e, t) {
            ;(e.display.gutterSpecs = hi(e.options.gutters, t)), gi(e)
          },
          !0,
        ),
        ...
        r('readOnly', !1, function (e, t) {
          'nocursor' == t && (Ln(e), e.display.input.blur()), e.display.input.readOnlyChanged(t)
        }),
        r(
          'disableInput',
          !1,
    ...
    (function (e) {
      ...
      ;(e.prototype = {
        ...
        indentSelection: ti(function (e) {
          for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
            ...
            if (i.empty()) i.head.line > r && (Ta(this, i.head.line, e, !0), (r = i.head.line), n == this.doc.sel.primIndex && Wn(this))
              ...
              0 == o.ch && t.length == u.length && u[n].from().ch > 0 && Xi(this.doc, n, new Ci(o, u[n].to()), V)
            }
          }
        }),
        ...
        coordsChar: function (e, t) {
          return Xr(this, (e = Gr(this, e, t || 'page')).left, e.top)
        },
        lineAtHeight: function (e, t) {
          return (e = Gr(this, { top: e, left: 0 }, t || 'page').top), Ze(this.doc, e + this.display.viewOffset)
        },
        ...
        addWidget: function (e, t, r, n, i) {
          var o,
            a,
            l = this.display,
            s = (e = qr(this, lt(this.doc, e))).bottom,
            u = e.left
          if (
            ...
            ;('above' == n || e.bottom + t.offsetHeight > c) && e.top > t.offsetHeight
          ...
          ;(t.style.top = s + 'px'),
            ...
            r &&
              (null != (a = An((o = this), { left: u, top: s, right: u + t.offsetWidth, bottom: s + t.offsetHeight })).scrollTop && Hn(o, a.scrollTop),
              null != a.scrollLeft && En(o, a.scrollLeft))
        },
        ...
        findPosH: function (e, t, r, n) {
          var i = 1
          t < 0 && ((i = -1), (t = -t))
          for (var o = lt(this.doc, e), a = 0; a < t && !(o = Ha(this.doc, o, i, r, n)).hitSide; ++a);
          return o
        },
        moveH: ti(function (e, t) {
          var r = this
          this.extendSelectionsBy(function (n) {
            return r.display.shift || r.doc.extend || n.empty() ? Ha(r.doc, n.head, e, t, r.options.rtlMoveVisually) : e < 0 ? n.from() : n.to()
          }, G)
        }),
        ...
        refresh: ti(function () {
          ...
          dn(this),
            ...
            ui(this.display),
            (null == e || Math.abs(e - rn(this.display)) > 0.5) && sn(this),
            pe(this, 'refresh', this)
        }),
  ...
  for (var Ga in Oo.prototype)
    Oo.prototype.hasOwnProperty(Ga) &&
      B(Ka, Ga) < 0 &&
      (Sa.prototype[Ga] = (function (e) {
        return function () {
  ...
  return (
    ye(Oo),
    (Sa.inputStyles = { textarea: Va, contenteditable: Ea }),
    (Sa.defineMode = function (e) {
      Sa.defaults.mode || 'null' == e || (Sa.defaults.mode = e), Ee.apply(this, arguments)
    }),
        ...
        ;(t.save = n),
          ...
          (t.toTextArea = function () {
            ;(t.toTextArea = isNaN),
              ...
              (e.style.display = ''),
              e.form && (he(e.form, 'submit', n), 'function' == typeof e.form.submit && (e.form.submit = i))
          })
      }),
  ...
  (function (e) {
    ...
    e.defineMode('css', function (t, r) {
      ...
      function k(e, t) {
        ...
        return '@' == r
          ...
          ? /[,+>*\/]/.test(r)
            ...
            ? x(null, r)
            : e.match(/[\w-.]+(?=\()/)
            ? (/^(url(-prefix)?|domain|regexp)$/.test(e.current().toLowerCase()) && (t.tokenize = S), x('variable callee', 'variable'))
            : /[\w\\\-]/.test(r)
          ...
          ? (e.eatWhile(/[\w.%]/), x('number', 'unit'))
          : e.match(/^-[\w\\\-]*/)
          ? (e.eatWhile(/[\w\\\-]/), e.match(/^\s*:/, !1) ? x('variable-2', 'variable-definition') : x('variable-2', 'variable'))
          : e.match(/^\w+-/)
          ? x('meta', 'meta')
          : void 0
      }
      ...
      function T(e, t, r, n) {
        return (e.context = new L(r, t.indentation() + (!1 === n ? 0 : a), e.context)), r
      }
      function M(e) {
      ...
      var W = {
        ...
        pseudo: function (e, t, r) {
          return 'meta' == e ? 'pseudo' : 'word' == e ? ((o = 'variable-3'), r.context.type) : N(e, t, r)
        },
        documentTypes: function (e, t, r) {
          return 'word' == e && s.hasOwnProperty(t.current()) ? ((o = 'tag'), r.context.type) : W.atBlock(e, t, r)
        },
        ...
        atComponentBlock: function (e, t, r) {
          return '}' == e ? A(e, t, r) : '{' == e ? M(r) && T(r, t, y ? 'block' : 'top', !1) : ('word' == e && (o = 'error'), r.context.type)
        },
        atBlock_parens: function (e, t, r) {
          return ')' == e ? M(r) : '{' == e || '}' == e ? A(e, t, r, 2) : W.atBlock(e, t, r)
        },
        restricted_atBlock_before: function (e, t, r) {
          return '{' == e
            ? T(r, t, 'restricted_atBlock')
        ...
        restricted_atBlock: function (e, t, r) {
          return '}' == e
            ...
            : 'word' == e
            ? ((o =
                ('@font-face' == r.stateArg && !p.hasOwnProperty(t.current().toLowerCase())) ||
        ...
        keyframes: function (e, t, r) {
          return 'word' == e ? ((o = 'variable'), 'keyframes') : '{' == e ? T(r, t, 'top') : N(e, t, r)
        },
        at: function (e, t, r) {
          return ';' == e ? M(r) : '{' == e || '}' == e ? A(e, t, r) : ('word' == e ? (o = 'tag') : 'hash' == e && (o = 'builtin'), 'at')
        },
        interpolation: function (e, t, r) {
          return '}' == e
            ...
            : '{' == e || ';' == e
            ? A(e, t, r)
            : ('word' == e ? (o = 'variable') : 'variable' != e && '(' != e && ')' != e && (o = 'error'), 'interpolation')
        },
      }
      return {
        startState: function (e) {
          return { tokenize: null, state: n ? 'block' : 'top', stateArg: null, context: new L(n ? 'block' : 'top', e || 0, null) }
        },
        token: function (e, t) {
        ...
        indent: function (e, t) {
          ...
          return (
            ...
            r.prev &&
              ('}' != n || ('block' != r.type && 'top' != r.type && 'interpolation' != r.type && 'restricted_atBlock' != r.type)
                ? ((')' != n || ('parens' != r.type && 'atBlock_parens' != r.type)) && ('{' != n || ('at' != r.type && 'atBlock' != r.type))) ||
    ...
    var r = ['domain', 'regexp', 'url', 'url-prefix'],
      ...
      b = t(y),
      w = r.concat(i).concat(a).concat(s).concat(c).concat(f).concat(m).concat(y)
    function x(e, t) {
  ...
  (function (e) {
    'object' == typeof exports && 'object' == typeof module
      ? e(require('../../lib/codemirror'), require('../xml/xml'), require('../javascript/javascript'), require('../css/css'))
      : 'function' == typeof define && define.amd
      ? define(['../../lib/codemirror', '../xml/xml', '../javascript/javascript', '../css/css'], e)
      : e(CodeMirror)
  })(function (e) {
    'use strict'
    var t = {
    ...
    function n(e, t) {
      var n = e.match(
        (function (e) {
          return r[e] || (r[e] = new RegExp('\\s+' + e + '\\s*=\\s*(\'|")?([^\'"]+)(\'|")?\\s*'))
        })(t),
      )
        ...
        return {
          ...
          copyState: function (t) {
            ...
            return (
              ...
              { token: t.token, inTag: t.inTag, localMode: t.localMode, localState: r, htmlState: e.copyState(l, t.htmlState) }
            )
          },
          token: function (e, t) {
            return t.token(e, t)
  ...
  (function (e) {
    ...
    e.defineMode('javascript', function (t, r) {
      ...
      function T(e) {
        ...
        r.globalVars && !L(e, t.globalVars) && (t.globalVars = new A(e, t.globalVars))
      }
      function M(e) {
      ...
      var O = new A('this', new A('arguments', null))
      function W() {
        ;(k.state.context = new N(k.state.context, k.state.localVars, !1)), (k.state.localVars = O)
      }
      function D() {
        ;(k.state.context = new N(k.state.context, k.state.localVars, !0)), (k.state.localVars = null)
      }
      function z() {
      ...
      function E(e, t) {
        return 'var' == e
          ...
          ? S()
          : 'if' == e
          ? ('else' == k.state.lexical.info && k.state.cc[k.state.cc.length - 1] == H && k.state.cc.pop()(), S(P('form'), j, E, H, Se))
          : 'function' == e
          ? S(Ne)
          : 'for' == e
          ? S(P('form'), Le, E, H)
          : 'class' == e || (u && 'interface' == t)
          ? ((k.marked = 'keyword'), S(P('form', 'class' == e ? e : t), ze, H))
          : 'variable' == e
          ? u && 'declare' == t
            ? ((k.marked = 'keyword'), S(E))
            : u && ('module' == t || 'enum' == t || 'type' == t) && k.stream.match(/^\s*\w/, !1)
            ? ((k.marked = 'keyword'), 'enum' == t ? S(Ue) : 'type' == t ? S(Oe, I('operator'), ce, I(';')) : S(P('form'), be, I('{'), P('}'), oe, H, H))
            : u && 'namespace' == t
            ? ((k.marked = 'keyword'), S(P('form'), R, E, H))
            : u && 'abstract' == t
            ? ((k.marked = 'keyword'), S(E))
            : S(P('stat'), Q)
          : 'switch' == e
          ? S(P('form'), j, I('{'), P('}', 'switch'), D, oe, H, H, z)
          : 'case' == e
          ? S(R, I(':'))
          : 'default' == e
          ? S(I(':'))
      ...
      function V(e, t, r) {
        ...
        return b.hasOwnProperty(e)
          ...
          ? S(Ne, i)
          : 'class' == e || (u && 'interface' == t)
          ? ((k.marked = 'keyword'), S(P('form'), De, H))
          : 'keyword c' == e || 'async' == e
          ? S(r ? B : R)
          : '(' == e
          ? S(P(')'), K, I(')'), H, i)
          ...
          ? S(
              (function (e) {
                return function (t) {
                  return '.' == t ? S(e ? Z : Y) : 'variable' == t && u ? S(ge, e ? U : G) : C(e ? B : R)
                }
              })(r),
            )
          : 'import' == e
      ...
      function K(e) {
        return e.match(/[;\}\)\],]/) ? C() : C(R)
      }
      function G(e, t) {
        return ',' == e ? S(R) : U(e, t, !1)
      }
      function U(e, t, r) {
        var n = 0 == r ? G : U,
          i = 0 == r ? R : B
      ...
      function q(e, t) {
        return 'quasi' != e ? C() : '${' != t.slice(t.length - 2) ? S(q) : S(R, _)
      }
      function _(e) {
        if ('}' == e) return (k.marked = 'string-2'), (k.state.tokenize = v), S(q)
      }
      function $(e) {
        return y(k.stream, k.state), C('{' == e ? E : R)
      }
      function X(e) {
        return y(k.stream, k.state), C('{' == e ? E : B)
      }
      function Y(e, t) {
      ...
      function ee(e, t) {
        return 'async' == e
          ...
          ? ((k.marked = 'property'),
            'get' == t || 'set' == t
              ? S(te)
              : (u && k.state.fatArrowAt == k.stream.start && (r = k.stream.match(/^\s*:\s*/, !1)) && (k.state.fatArrowAt = k.stream.pos + r[0].length), S(re)))
          : 'number' == e || 'string' == e
          ? ((k.marked = l ? 'property' : k.style + ' property'), S(re))
          : 'jsonld-keyword' == e
          ? S(re)
          : u && M(t)
      ...
      function te(e) {
        return 'variable' != e ? C(re) : ((k.marked = 'property'), S(Ne))
      }
      function re(e) {
        return ':' == e ? S(B) : '(' == e ? C(Ne) : void 0
      }
      function ne(e, t, r) {
        function n(i, o) {
          ...
          return i == t || o == t ? S() : r && r.indexOf(';') > -1 ? C(e) : S(I(t))
        }
        return function (r, i) {
      ...
      function se(e) {
        if (u && ':' == e) return k.stream.match(/^\s*\w+\s+is\b/, !1) ? S(R, ue, ce) : S(ce)
      }
      function ue(e, t) {
      ...
      function ce(e, t) {
        return 'keyof' == t || 'typeof' == t || 'infer' == t
          ? ((k.marked = 'keyword'), S('typeof' == t ? B : ce))
          : 'variable' == e || 'void' == t
          ? ((k.marked = 'type'), S(pe))
          : '|' == t || '&' == t
          ? S(ce)
      ...
      function fe(e, t) {
        return 'variable' == e || 'keyword' == k.style
          ? ((k.marked = 'property'), S(fe))
          : '?' == t || 'number' == e || 'string' == e
          ? S(fe)
          : ':' == e
          ? S(ce)
          : '[' == e
          ? S(I('variable'), le, I(']'), fe)
          : '(' == e
          ? C(Ae, fe)
          : void 0
      }
      function he(e, t) {
        return ('variable' == e && k.stream.match(/^\s*[?:]/, !1)) || '?' == t ? S(he) : ':' == e ? S(ce) : 'spread' == e ? S(he) : C(ce)
      }
      function pe(e, t) {
        return '<' == t
          ? S(P('>'), ne(ce, '>'), H, pe)
          ...
          ? ((k.marked = 'keyword'), S(ce))
          : '?' == t
          ? S(ce, I(':'), ce)
          : void 0
      }
      function ge(e, t) {
        if ('<' == t) return S(P('>'), ne(ce, '>'), H, pe)
      }
      function me() {
        return C(ce, ve)
      }
      ...
      function we(e, t) {
        return 'variable' != e || k.stream.match(/^\s*:/, !1)
          ? ('variable' == e && (k.marked = 'property'), 'spread' == e ? S(be) : '}' == e ? C() : '[' == e ? S(R, I(']'), I(':'), we) : S(I(':'), be, ke))
          : (T(t), S(ke))
      }
      function xe() {
        return C(be, ke)
      ...
      function Se(e, t) {
        if ('keyword b' == e && 'else' == t) return S(P('form', 'else'), E, H)
      }
      function Le(e, t) {
        return 'await' == t ? S(Le) : '(' == e ? S(P(')'), Te, H) : void 0
      }
      function Te(e) {
        return 'var' == e ? S(ye, Me) : 'variable' == e ? S(Me) : C(Me)
      }
      function Me(e, t) {
        return ')' == e ? S() : ';' == e ? S(Me) : 'in' == t || 'of' == t ? ((k.marked = 'keyword'), S(R, Me)) : C(R, Me)
      }
      function Ne(e, t) {
        return '*' == t
          ? ((k.marked = 'keyword'), S(Ne))
          : 'variable' == e
          ? (T(t), S(Ne))
          : '(' == e
          ? S(W, P(')'), ne(We, ')'), H, se, E, z)
          : u && '<' == t
          ? S(P('>'), ne(me, '>'), H, Ne)
          : void 0
      }
      ...
      function Oe(e, t) {
        return 'keyword' == e || 'variable' == e ? ((k.marked = 'type'), S(Oe)) : '<' == t ? S(P('>'), ne(me, '>'), H) : void 0
      }
      function We(e, t) {
        return '@' == t && S(R, We), 'spread' == e ? S(We) : u && M(t) ? ((k.marked = 'keyword'), S(We)) : u && 'this' == e ? S(ae, ke) : C(be, ae, ke)
      }
      function De(e, t) {
        return 'variable' == e ? ze(e, t) : Pe(e, t)
      }
      function ze(e, t) {
        if ('variable' == e) return T(t), S(Pe)
      }
      function Pe(e, t) {
        return '<' == t
          ? S(P('>'), ne(me, '>'), H, Pe)
          : 'extends' == t || 'implements' == t || (u && ',' == e)
          ? ('implements' == t && (k.marked = 'keyword'), S(u ? ce : R, Pe))
          : '{' == e
          ? S(P('}'), He, H)
          : void 0
      }
      function He(e, t) {
        return 'async' == e || ('variable' == e && ('static' == t || 'get' == t || 'set' == t || (u && M(t))) && k.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
          ? ((k.marked = 'keyword'), S(He))
          : 'variable' == e || 'keyword' == k.style
          ? ((k.marked = 'property'), S(u ? Ie : Ne, He))
          : 'number' == e || 'string' == e
          ? S(u ? Ie : Ne, He)
          : '[' == e
          ? S(R, ae, I(']'), u ? Ie : Ne, He)
      ...
      function Ie(e, t) {
        ...
        return C(r && 'interface' == r.info ? Ae : Ne)
      }
      function Ee(e, t) {
        return '*' == t
          ? ((k.marked = 'keyword'), S(Ke, I(';')))
          : 'default' == t
          ? ((k.marked = 'keyword'), S(R, I(';')))
          : '{' == e
          ? S(ne(Fe, '}'), Ke, I(';'))
          : C(E)
      }
      function Fe(e, t) {
        return 'as' == t ? ((k.marked = 'keyword'), S(I('variable'))) : 'variable' == e ? C(B, Fe) : void 0
      }
      function Re(e) {
        return 'string' == e ? S() : '(' == e ? C(R) : C(Be, je, Ke)
      }
      function Be(e, t) {
        return '{' == e ? ie(Be, '}') : ('variable' == e && T(t), '*' == t && (k.marked = 'keyword'), S(Ve))
      }
      function je(e) {
        if (',' == e) return S(Be, je)
      }
      function Ve(e, t) {
        if ('as' == t) return (k.marked = 'keyword'), S(Be)
      }
      function Ke(e, t) {
        if ('from' == t) return (k.marked = 'keyword'), S(R)
      }
      function Ge(e) {
        return ']' == e ? S() : C(ne(B, ']'))
      }
      function Ue() {
        return C(P('form'), be, I('{'), P('}'), ne(qe, '}'), H, H)
      }
      function qe() {
        return C(be, ke)
      }
      function _e(e, t, r) {
        return (
          (t.tokenize == g && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)) ||
        ...
        (H.lex = !0),
        {
          startState: function (e) {
            var t = {
              ...
              context: r.localVars && new N(null, null, !1),
              indented: e || 0,
            }
          ...
          token: function (e, t) {
            if (
              (e.sol() && (t.lexical.hasOwnProperty('align') || (t.lexical.align = !1), (t.indented = e.indentation()), y(e, t)),
              t.tokenize != m && e.eatSpace())
            )
              return null
            var r = t.tokenize(e, t)
            return 'comment' == n
              ? r
              : ((t.lastType = 'operator' != n || ('++' != i && '--' != i) ? n : 'incdec'),
                (function (e, t, r, n, i) {
                  var o = e.cc
                  for (k.state = e, k.stream = i, k.marked = null, k.cc = o, k.style = t, e.lexical.hasOwnProperty('align') || (e.lexical.align = !0); ; )
                    if ((o.length ? o.pop() : s ? R : E)(r, n)) {
          ...
          indent: function (t, n) {
            ...
            for (; ('stat' == s.type || 'form' == s.type) && ('}' == l || ((i = t.cc[t.cc.length - 1]) && (i == G || i == U) && !/^[,\.=+\-*:?[\(]/.test(n))); )
              s = s.prev
  ...
  (function (e) {
    ...
    e.defineMode('xml', function (n, i) {
      ...
      function y(e, t, r) {
        return 'word' == e
          ? ((r.tagName = t.current()), (a = 'tag'), k)
          : s.allowMissingTagName && 'endTag' == e
          ? ((a = 'tag bracket'), k(e, t, r))
          : ((a = 'error'), y)
      }
      function b(e, t, r) {
        if ('word' == e) {
          var n = t.current()
          return (
            r.context && r.context.tagName != n && s.implicitlyClosed.hasOwnProperty(r.context.tagName) && g(r),
            (r.context && r.context.tagName == n) || !1 === s.matchClosing ? ((a = 'tag'), w) : ((a = 'tag error'), x)
          )
        }
        return s.allowMissingTagName && 'endTag' == e ? ((a = 'tag bracket'), w(e, t, r)) : ((a = 'error'), x)
      }
      function w(e, t, r) {
        return 'endTag' != e ? ((a = 'error'), w) : (g(r), v)
      }
      function x(e, t, r) {
        return (a = 'error'), w(e, 0, r)
      }
      function k(e, t, r) {
        ...
        if ('endTag' == e || 'selfcloseTag' == e) {
          ...
          return (
            ...
            'selfcloseTag' == e || s.autoSelfClosers.hasOwnProperty(n) ? m(r, n) : (m(r, n), (r.context = new p(r, n, i == r.indented))),
            v
          )
        }
        return (a = 'error'), k
      ...
      function C(e, t, r) {
        return 'equals' == e ? S : (s.allowMissing || (a = 'error'), k(e, 0, r))
      }
      function S(e, t, r) {
        return 'string' == e ? L : 'word' == e && s.allowUnquoted ? ((a = 'string'), k) : ((a = 'error'), k(e, 0, r))
      }
      function L(e, t, r) {
        return 'string' == e ? L : k(e, 0, r)
      }
      return (
        (d.isInText = !0),
        {
