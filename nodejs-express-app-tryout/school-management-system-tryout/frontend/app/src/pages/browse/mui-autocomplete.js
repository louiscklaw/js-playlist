      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer
            ...
            name="autocomplete-hint.js"
          />
          <WidgetPreviewer
            element={<CheckboxesTags />}
            name="checkboxes-tags.js"
          />
          <WidgetPreviewer element={<ComboBox />} name="combo-box.js" />
          <WidgetPreviewer
            element={<ControllableStates />}
            name="controllable-states.js"
          />
          <WidgetPreviewer
          ...
          />
          <WidgetPreviewer
            element={<CustomInputAutocomplete />}
            name="custom-input-autocomplete.js"
          />
          {/* <WidgetPreviewer element={<CustomizedHook />} name="customized-hook.js" /> */}
          <WidgetPreviewer
            element={<DisabledOptions />}
            name="disabled-options.js"
          />
          ...
          <WidgetPreviewer
            element={<FreeSoloCreateOption />}
            name="free-solo-create-option.js"
          />
          <WidgetPreviewer
            element={<FreeSoloCreateOptionDialog />}
            name="free-solo-create-option-dialog.js"
          />
