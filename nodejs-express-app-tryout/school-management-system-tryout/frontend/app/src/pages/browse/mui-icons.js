    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<CreateSvgIcon />}
            name="create-svg-icon.js"
          />
          ...
          <WidgetPreviewer
            element={<SvgIconChildren />}
            name="svg-icon-children.js"
          />
          <WidgetPreviewer
            element={<SvgIconsColor />}
            name="svg-icons-color.js"
          />
          <WidgetPreviewer
            element={<SvgIconsSize />}
            name="svg-icons-size.js"
          />
          <WidgetPreviewer
            element={<SvgMaterialIcons />}
            name="svg-material-icons.js"
          />
          <WidgetPreviewer
            element={<TwoToneIcons />}
            name="two-tone-icons.js"
          />
        </Container>
      </Box>
    </>
