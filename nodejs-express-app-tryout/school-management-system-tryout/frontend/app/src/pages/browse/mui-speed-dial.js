    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<BasicSpeedDial />}
            name="basic-speed-dial.js"
          />
          <WidgetPreviewer
            element={<ControlledOpenSpeedDial />}
            name="controlled-open-speed-dial.js"
          />
          <WidgetPreviewer
            element={<OpenIconSpeedDial />}
            name="open-icon-speed-dial.js"
          />
          <WidgetPreviewer
            element={<PlaygroundSpeedDial />}
            name="playground-speed-dial.js"
          />
          <WidgetPreviewer
            element={<SpeedDialTooltipOpen />}
            name="speed-dial-tooltip-open.js"
          />
        </Container>
      </Box>
    </>
