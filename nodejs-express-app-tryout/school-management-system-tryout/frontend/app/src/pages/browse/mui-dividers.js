    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer
            element={<InsetDividers />}
            name="inset-dividers.js"
          />
          <WidgetPreviewer element={<ListDividers />} name="list-dividers.js" />
          <WidgetPreviewer
            element={<MiddleDividers />}
            name="middle-dividers.js"
          />
          <WidgetPreviewer
            element={<SubheaderDividers />}
            name="subheader-dividers.js"
          />
          <WidgetPreviewer
            element={<VerticalDividerMiddle />}
            name="vertical-divider-middle.js"
          />
          <WidgetPreviewer
            element={<VerticalDividerText />}
            name="vertical-divider-text.js"
          />
          <WidgetPreviewer
            element={<VerticalDividers />}
            name="vertical-dividers.js"
          />
        </Container>
      </Box>
    </>
