    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<BasicSwitches />}
            name="basic-switches.js"
          />
          <WidgetPreviewer
            element={<ColorSwitches />}
            name="color-switches.js"
          />
          <WidgetPreviewer
            element={<ControlledSwitches />}
            name="controlled-switches.js"
          />
          <WidgetPreviewer
            element={<CustomizedSwitches />}
            name="customized-switches.js"
          />
          <WidgetPreviewer
          ...
          <WidgetPreviewer
            element={<SwitchesGroup />}
            name="switches-group.js"
          />
