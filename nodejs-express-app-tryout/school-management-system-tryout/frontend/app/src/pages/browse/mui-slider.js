    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer
            element={<ContinuousSlider />}
            name="continuous-slider.js"
          />
          <WidgetPreviewer
            element={<CustomizedSlider />}
            name="customized-slider.js"
          />
          <WidgetPreviewer
            element={<DiscreteSlider />}
            name="discrete-slider.js"
          />
          <WidgetPreviewer
            element={<DiscreteSliderLabel />}
            name="discrete-slider-label.js"
          />
          <WidgetPreviewer
            element={<DiscreteSliderMarks />}
            name="discrete-slider-marks.js"
          />
          <WidgetPreviewer
            element={<DiscreteSliderSteps />}
            name="discrete-slider-steps.js"
          />
          <WidgetPreviewer
            element={<DiscreteSliderValues />}
            name="discrete-slider-values.js"
          />
          <WidgetPreviewer element={<InputSlider />} name="input-slider.js" />
          <WidgetPreviewer
            element={<MinimumDistanceSlider />}
            name="minimum-distance-slider.js"
          />

          {/* <WidgetPreviewer element={<MusicPlayerSlider />} name="music-player-slider.js" /> */}

          <WidgetPreviewer
            element={<NonLinearSlider />}
            name="non-linear-slider.js"
          />
          ...
          <WidgetPreviewer
            element={<TrackFalseSlider />}
            name="track-false-slider.js"
          />
          <WidgetPreviewer
            element={<TrackInvertedSlider />}
            name="track-inverted-slider.js"
          />
