    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<AccessibilityTooltips />}
            name="accessibility-tooltips.js"
          />
          <WidgetPreviewer
            element={<AnchorElTooltips />}
            name="anchor-el-tooltips.js"
          />
          <WidgetPreviewer
            element={<ArrowTooltips />}
            name="arrow-tooltips.js"
          />
          <WidgetPreviewer element={<BasicTooltip />} name="basic-tooltip.js" />
          <WidgetPreviewer
            element={<ControlledTooltips />}
            name="controlled-tooltips.js"
          />
          <WidgetPreviewer
            element={<CustomizedTooltips />}
            name="customized-tooltips.js"
          />
          <WidgetPreviewer
            element={<DelayTooltips />}
            name="delay-tooltips.js"
          />
          <WidgetPreviewer
            element={<DisabledTooltips />}
            name="disabled-tooltips.js"
          />
          <WidgetPreviewer
            element={<FollowCursorTooltips />}
            name="follow-cursor-tooltips.js"
          />
          <WidgetPreviewer
            element={<NotInteractiveTooltips />}
            name="non-interactive-tooltips.js"
          />
          <WidgetPreviewer
            element={<PositionedTooltips />}
            name="positioned-tooltips.js"
          />
          <WidgetPreviewer
            element={<TransitionsTooltips />}
            name="transitions-tooltips.js"
          />
          <WidgetPreviewer
            element={<TriggersTooltips />}
            name="triggers-tooltips.js"
          />
          <WidgetPreviewer
            element={<VariableWidth />}
            name="variable-width.js"
          />
        </Container>
      </Box>
    </>
