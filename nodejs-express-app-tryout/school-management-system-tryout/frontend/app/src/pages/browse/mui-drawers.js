      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            ...
            name="clipped-drawer.js"
          />
          <WidgetPreviewer element={<MiniDrawer />} name="mini-drawer.js" />
          <WidgetPreviewer
            element={<PermanentDrawerLeft />}
            name="permanent-drawer-left.js"
          />
          <WidgetPreviewer
            element={<PermanentDrawerRight />}
            name="permanent-drawer-right.js"
          />
          <WidgetPreviewer
            element={<PersistentDrawerLeft />}
            name="persistent-drawer-left.js"
          />
          <WidgetPreviewer
            element={<PersistentDrawerRight />}
            name="persistent-drawer-right.js"
          />
          ...
          <WidgetPreviewer
            ...
            name="swipeable-temporary-drawer.js"
          />
          <WidgetPreviewer
            element={<TemporaryDrawer />}
            name="temporary-drawer.js"
          />
        </Container>
      </Box>
    </>
