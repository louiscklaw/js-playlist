      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            ...
            name="basic-pagination.js"
          />
          <WidgetPreviewer element={<CustomIcons />} name="custom-icons.js" />
          <WidgetPreviewer
            element={<PaginationButtons />}
            name="pagination-buttons.js"
          />
          <WidgetPreviewer
            element={<PaginationControlled />}
            name="pagination-controlled.js"
          />
          {/* <WidgetPreviewer element={<PaginationLink />} name="pagination-link.js" /> */}
          <WidgetPreviewer
            element={<PaginationOutlined />}
            name="pagination-outlined.js"
          />
          <WidgetPreviewer
            element={<PaginationRanges />}
            name="pagination-ranges.js"
          />
          <WidgetPreviewer
            element={<PaginationRounded />}
            name="pagination-rounded.js"
          />
          <WidgetPreviewer
            element={<PaginationSize />}
            name="pagination-size.js"
          />
          {/* <WidgetPreviewer element={<TablePagination />} name="table-pagination.js" /> */}
          <WidgetPreviewer
            element={<UsePagination />}
            name="use-pagination.js"
          />
        </Container>
      </Box>
    </>
