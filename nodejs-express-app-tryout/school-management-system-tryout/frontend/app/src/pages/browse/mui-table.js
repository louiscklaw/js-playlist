    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<AccessibleTable />}
            name="accessible-table.js"
          />
          <WidgetPreviewer element={<BasicTable />} name="basic-table.js" />
          <WidgetPreviewer
            element={<CollapsibleTable />}
            name="collapsible-table.js"
          />
          <WidgetPreviewer
            element={<ColumnGroupingTable />}
            name="column-grouping-table.js"
          />
          <WidgetPreviewer
            element={<CustomPaginationActionsTable />}
            name="custom-pagination-actions-table.js"
          />
          <WidgetPreviewer
            element={<CustomizedTables />}
            name="customized-tables.js"
          />
