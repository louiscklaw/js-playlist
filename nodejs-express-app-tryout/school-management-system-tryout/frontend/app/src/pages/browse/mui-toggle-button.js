    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<ColorToggleButton />}
            name="color-toggle-button.js"
          />
          <WidgetPreviewer
            element={<CustomizedDividers />}
            name="customized-dividers.js"
          />
          <WidgetPreviewer
            element={<StandaloneToggleButton />}
            name="standalone-toggle-button.js"
          />
          <WidgetPreviewer
            element={<ToggleButtonNotEmpty />}
            name="toggle-button-not-empty.js"
          />
          <WidgetPreviewer
            element={<ToggleButtonSizes />}
            name="toggle-button-sizes.js"
          />
          <WidgetPreviewer
            element={<ToggleButtons />}
            name="toggle-buttons.js"
          />
          <WidgetPreviewer
            element={<ToggleButtonsMultiple />}
            name="toggle-buttons-multiple.js"
          />
          <WidgetPreviewer
            element={<VerticalToggleButtons />}
            name="vertical-toggle-buttons.js"
          />
        </Container>
      </Box>
    </>
