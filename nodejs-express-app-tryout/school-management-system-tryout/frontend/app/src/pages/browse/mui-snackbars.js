    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer
            element={<ConsecutiveSnackbars />}
            name="consecutive-snackbars.js"
          />
          <WidgetPreviewer
            element={<CustomizedSnackbars />}
            name="customized-snackbars.js"
          />
          <WidgetPreviewer
            element={<DirectionSnackbar />}
            name="direction-snackbar.js"
          />
          <WidgetPreviewer
            element={<FabIntegrationSnackbar />}
            name="fab-integration-snackbar.js"
          />
          {/* <WidgetPreviewer element={<IntegrationNotistack />} name="integration-notistack.js" /> */}
          <WidgetPreviewer
            element={<LongTextSnackbar />}
            name="long-text-snackbar.js"
          />
          <WidgetPreviewer
            element={<PositionedSnackbar />}
            name="positioned-snackbar.js"
          />
          <WidgetPreviewer
            element={<SimpleSnackbar />}
            name="simple-snackbar.js"
          />
          <WidgetPreviewer
            element={<TransitionsSnackbar />}
            name="transitions-snackbar.js"
          />
        </Container>
      </Box>
    </>
