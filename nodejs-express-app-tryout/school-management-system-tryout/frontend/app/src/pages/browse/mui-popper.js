    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer
            element={<PositionedPopper />}
            name="positioned-popper.js"
          />
          ...
          <WidgetPreviewer
            element={<TransitionsPopper />}
            name="transitions-popper.js"
          />
          <WidgetPreviewer
            element={<VirtualElementPopper />}
            name="virtual-element-popper.js"
          />
        </Container>
      </Box>
    </>
