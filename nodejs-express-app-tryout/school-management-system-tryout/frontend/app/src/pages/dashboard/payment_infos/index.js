...
import { PaymentInfoListTable } from 'src/components/dashboard/payment_info/payment_info-list-table';
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">{t('Payment Infos')}</Typography>
              </Grid>
          ...
          <Card>
            ...
            >
              ...
              >
                <TextField
                  ...
                  placeholder="Search payment infos"
                />
              </Box>
              <TextField
                label="Sort By"
            ...
            <PaymentInfoListTable
              payment_infos={paginatedStudents}
              paymentInfosCount={filteredStudents.length}
