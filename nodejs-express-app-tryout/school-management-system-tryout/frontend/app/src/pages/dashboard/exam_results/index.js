...
import { ExamResultListTable } from 'src/components/dashboard/exam_result/exam_result-list-table';
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">{t('Exam Results')}</Typography>
              </Grid>
          ...
          <Card>
            ...
            <ExamResultListTable
              exam_results={paginatedStudents}
              examResultsCount={filteredStudents.length}
