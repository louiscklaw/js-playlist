...
import { ClassroomListTable } from 'src/components/dashboard/classroom/classroom-list-table';
...
const StudentList = () => {
  ...
  const getStudents = useCallback(async () => {
    try {
      ...
      const data = await classroomApi.getStudents();
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">{t('Classrooms')}</Typography>
              </Grid>
          ...
          <Card>
            ...
            <ClassroomListTable
              classrooms={paginatedStudents}
              classroomsCount={filteredStudents.length}
