...
import { ScheduleListTable } from 'src/components/dashboard/schedule/schedule-list-table';
      ...
      <Box component="main" sx={{ flexGrow: 1, py: 8 }}>
        <Container maxWidth="xl">
          ...
          <Card>
            ...
            <ScheduleListTable
              schedules={paginatedStudents}
              schedulesCount={filteredStudents.length}
