...
import { ExamListTable } from 'src/components/dashboard/exam/exam-list-table';
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">{t('Exams')}</Typography>
              </Grid>
          ...
          <Card>
            ...
            <ExamListTable
              exams={paginatedStudents}
              examsCount={filteredStudents.length}
