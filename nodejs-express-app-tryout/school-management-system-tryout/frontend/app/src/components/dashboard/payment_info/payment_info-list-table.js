...
export const PaymentInfoListTable = props => {
  const {
    payment_infos,
    paymentInfosCount,
    onPageChange,
  ...
  const handleSelectAllCustomers = event => {
    setSelectedCustomers(
      event.target.checked ? payment_infos.map(customer => customer.id) : [],
    );
  };
  ...
  const selectedSomeCustomers =
    ...
    selectedCustomers.length < payment_infos.length;
...
PaymentInfoListTable.propTypes = {
