...
class TeacherApi {
  getTeacherCount() {
    return axios.get(`${API_ENDPOINT}/teachers/getTeacherCount`);
  }

  addTeacher(values) {
    return axios.post(`${API}/teachers`, values);
  }

  deleteTeacherById(studentId) {
    return axios.delete(`${API}/teachers/${studentId}`);
  }

  // TODO: delete this
  updateStudentByIdObsolete(studentId, values) {
    return axios
      .patch(`${API}/students/${studentId}`, values)
      .then(response => {
