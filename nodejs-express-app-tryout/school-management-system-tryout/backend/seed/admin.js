...
const seedAdmin = () => mongoose.connect("mongodb://localhost:27017/node-boilerplate", config.mongoose.options)
  .then(() => {
  ...
  .then(() => {
    const saving = Array(1).fill(0).map((_, idx) => {
      const newAdmin = new Admin({
        avatar: 'https://plus.unsplash.com/premium_photo-1661715626413-97025519e975?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
        city: 'Cleveland',
        country: 'USA',
        currency: '$',
