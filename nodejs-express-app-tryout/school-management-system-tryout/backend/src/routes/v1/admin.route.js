 ...
 *     description: Only admins can retrieve all admins.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get a admin
 *     description: Logged in admins can fetch only their own admin information. Only admins can fetch other admins.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in admins can only update their own information. Only admins can update other admins.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in admins can delete only themselves. Only admins can delete other admins.
 *     tags: [Students]
 *     security:
 *       - bearerAuth: []
 *     parameters:
