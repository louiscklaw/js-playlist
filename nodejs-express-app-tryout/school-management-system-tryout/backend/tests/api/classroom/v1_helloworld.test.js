...
const { classroomOne, insertClassrooms } = require('../../fixtures/classroom.fixture');
...
describe('Classroom CRUD test', () => {
  ...
  test('get classroom count', async () => {
    ...
    const res = await request(app)
      .get('/v1/classrooms/getClassroomCount')
  ...
  test('GET /v1/classrooms/helloworld',
    async () => {
      const res = await request(app)
        .get('/v1/classrooms/helloworld')
        .expect(httpStatus.OK);
    });
});
