    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <div>
            <WidgetPreviewer element={<CustomizedSteppers />} name="customized-steppers.js" />
            <WidgetPreviewer element={<DotsMobileStepper />} name="dots-mobile-stepper.js" />
            {/* <WidgetPreviewer element={<HorizontalLinearAlternativeLabelStepper />} name="horizontal-linear-alternative-label-stepper.js" /> */}
            <WidgetPreviewer element={<HorizontalLinearStepper />} name="horizontal-linear-stepper.js" />
            <WidgetPreviewer element={<HorizontalNonLinearStepper />} name="horizontal-non-linear-stepper.js" />
            <WidgetPreviewer element={<HorizontalStepperWithError />} name="horizontal-stepper-with-error.js" />
            <WidgetPreviewer element={<ProgressMobileStepper />} name="progress-mobile-stepper.js" />
            {/* <WidgetPreviewer element={<SwipeableTextMobileStepper />} name="swipeable-text-mobile-stepper.js" /> */}
            <WidgetPreviewer element={<TextMobileStepper />} name="text-mobile-stepper.js" />
            <WidgetPreviewer element={<VerticalLinearStepper />} name="vertical-linear-stepper.js" />
          </div>
        </Container>
      </Box>
    </>
