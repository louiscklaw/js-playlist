      ...
      >
        <Container maxWidth="lg">
          ...
          <div>
            ...
            <WidgetPreviewer element={<ClickableAndDeletableChips />} name="clickable-and-deletable-chips.js" />
            <WidgetPreviewer element={<ClickableChips />} name="clickable-chips.js" />
            <WidgetPreviewer element={<ClickableLinkChips />} name="clickable-link-chips.js" />
            <WidgetPreviewer element={<ColorChips />} name="color-chips.js" />
            <WidgetPreviewer element={<CustomDeleteIconChips />} name="custom-delete-icon-chips.js" />
            <WidgetPreviewer element={<DeletableChips />} name="deletable-chips.js" />
            <WidgetPreviewer element={<IconChips />} name="icon-chips.js" />
            <WidgetPreviewer element={<MultilineChips />} name="multiline-chips.js" />
