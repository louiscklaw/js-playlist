    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer element={<ControlledOpenSelect />} name="controlled-open-select.js" />
          <WidgetPreviewer element={<CustomizedSelects />} name="customized-selects.js" />
          <WidgetPreviewer element={<DialogSelect />} name="dialog-select.js" />
          <WidgetPreviewer element={<GroupedSelect />} name="grouped-select.js" />
          <WidgetPreviewer element={<MultipleSelect />} name="multiple-select.js" />
          <WidgetPreviewer element={<MultipleSelectCheckmarks />} name="multiple-select-checkmarks.js" />
          <WidgetPreviewer element={<MultipleSelectChip />} name="multiple-select-chip.js" />
          <WidgetPreviewer element={<MultipleSelectNative />} name="multiple-select-native.js" />
          <WidgetPreviewer element={<MultipleSelectPlaceholder />} name="multiple-select-placeholder.js" />
          {/* <WidgetPreviewer element={<NativeSelect />} name="native-select.js" /> */}
          <WidgetPreviewer element={<SelectAutoWidth />} name="select-auto-width.js" />
          <WidgetPreviewer element={<SelectLabels />} name="select-labels.js" />
          <WidgetPreviewer element={<SelectOtherProps />} name="select-other-props.js" />
          <WidgetPreviewer element={<SelectSmall />} name="select-small.js" />
          <WidgetPreviewer element={<SelectVariants />} name="select-variants.js" />
        </Container>
      </Box>
    </>
  );
