    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer element={<FloatingActionButtonExtendedSize />} name="floating-action-button-extended-size.js" />
          <WidgetPreviewer element={<FloatingActionButtonSize />} name="floating-action-button-size.js" />
          {/* <WidgetPreviewer element={<FloatingActionButtonZoom />} name="floating-action-button-zoom.js" /> */}
          <WidgetPreviewer element={<FloatingActionButtons />} name="floating-action-buttons.js" />
        </Container>
      </Box>
    </>
  );
