    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer element={<BasicButtonGroup />} name="basic-button-group.js" />
          <WidgetPreviewer element={<DisableElevation />} name="disable-elevation.js" />
          <WidgetPreviewer element={<GroupOrientation />} name="group-orientation.js" />
          <WidgetPreviewer element={<GroupSizesColors />} name="group-sizes-colors.js" />
          <WidgetPreviewer element={<SplitButton />} name="split-button.js" />
          <WidgetPreviewer element={<VariantButtonGroup />} name="variant-button-group.js" />
        </Container>
      </Box>
    </>
  );
