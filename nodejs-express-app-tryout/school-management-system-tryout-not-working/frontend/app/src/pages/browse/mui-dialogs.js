    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer element={<AlertDialogSlide />} name="alert-dialog-slide.js" />
          <WidgetPreviewer element={<ConfirmationDialog />} name="confirmation-dialog.js" />
          <WidgetPreviewer element={<CustomizedDialogs />} name="customized-dialogs.js" />
          {/* <WidgetPreviewer element={<DraggableDialog />} name="draggable-dialog.js" /> */}
          <WidgetPreviewer element={<FormDialog />} name="form-dialog.js" />
          <WidgetPreviewer element={<FullScreenDialog />} name="full-screen-dialog.js" />
          <WidgetPreviewer element={<MaxWidthDialog />} name="max-width-dialog.js" />
          <WidgetPreviewer element={<ResponsiveDialog />} name="responsive-dialog.js" />
