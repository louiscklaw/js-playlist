    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <WidgetPreviewer element={<ActiveLastBreadcrumb />} name="active-last-breadcrumb.js" />
          <WidgetPreviewer element={<BasicBreadcrumbs />} name="basic-breadcrumbs.js" />
          <WidgetPreviewer element={<CollapsedBreadcrumbs />} name="collapsed-breadcrumbs.js" />
          <WidgetPreviewer element={<CustomSeparator />} name="custom-separator.js" />
          <WidgetPreviewer element={<CustomizedBreadcrumbs />} name="customized-breadcrumbs.js" />
          <WidgetPreviewer element={<IconBreadcrumbs />} name="icon-breadcrumbs.js" />
