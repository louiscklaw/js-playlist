    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          ...
          <WidgetPreviewer element={<BottomAppBar />} name="bottom-app-bar.js" />
          <WidgetPreviewer element={<ButtonAppBar />} name="button-app-bar.js" />
          <WidgetPreviewer element={<DenseAppBar />} name="dense-app-bar.js" />
          {/* <WidgetPreviewer element={<DrawerAppBar />} name="drawer-app-bar.js" /> */}
          <WidgetPreviewer element={<ElevateAppBar />} name="elevate-app-bar.js" />
          <WidgetPreviewer element={<EnableColorOnDarkAppBar />} name="enable-color-on-dark-app-bar.js" />
          <WidgetPreviewer element={<HideAppBar />} name="hide-app-bar.js" />
          <WidgetPreviewer element={<MenuAppBar />} name="menu-app-bar.js" />
          <WidgetPreviewer element={<PrimarySearchAppBar />} name="primary-search-app-bar.js" />
          <WidgetPreviewer element={<ProminentAppBar />} name="prominent-app-bar.js" />
          {/* <WidgetPreviewer element={<ResponsiveAppBar />} name="responsive-app-bar.js" /> */}
          <WidgetPreviewer element={<SearchAppBar />} name="search-app-bar.js" />
        </Container>
      </Box>
    </>
  );
