...
import { ExclamationCircle as ExclamationCircleIcon } from 'src/icons/exclamation-circle';
import { Star as StarIcon } from 'src/icons/star';
import { Inbox as InboxIcon } from 'src/icons/inbox';
import { Mail as MailIcon } from 'src/icons/mail';
import { MailOpen as MailOpenIcon } from 'src/icons/mail-open';
import { Trash as TrashIcon } from 'src/icons/trash';
import { TagOutlined as TagOutlinedIcon } from 'src/icons/tag-outlined';
import { PaperAirplane as PaperAirplaneIcon } from 'src/icons/paper-airplane';
