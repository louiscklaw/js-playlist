    ...
    items: [
      {
        ...
        children: [
          { title: t('List'), path: '/dashboard/students' },
          { title: t('Details'), path: '/dashboard/students/1' },
          { title: t('Edit'), path: '/dashboard/students/1/edit' },
        ],
      },
      {
        title: t('Teachers'),
        ...
        icon: <UsersIcon fontSize="small" />,
        children: [
          { title: t('List'), path: '/dashboard/teachers' },
          { title: t('Details'), path: '/dashboard/teachers/1' },
          { title: t('Edit'), path: '/dashboard/teachers/1/edit' },
        ],
      },
      {
        title: t('Admins'),
        ...
        icon: <UsersIcon fontSize="small" />,
        children: [
          { title: t('List'), path: '/dashboard/admins' },
          { title: t('Details'), path: '/dashboard/admins/1' },
          { title: t('Edit'), path: '/dashboard/admins/1/edit' },
        ],
      },
      {
        title: t('Customers'),
