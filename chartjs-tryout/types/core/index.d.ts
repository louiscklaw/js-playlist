...
import { Color, EasingFunction, IChartArea, IChartComponent, IFontSpec, IPoint, Scriptable, TimeUnit, IEvent } from './interfaces'
...
export const Chart: {
  prototype: Chart
  new <T = number, L = string, C extends IChartConfiguration<string, T, L> = IChartConfiguration<string, T, L>>(item: ChartItem, config: C): Chart<T, L, C>
...
export interface Element<T = {}, O = {}> {
  ...
  getProps<P extends keyof T, P2 extends keyof T, P3 extends keyof T>(props: [P, P2, P3], final?: boolean): Pick<T, P | P2 | P3>
  getProps<P extends keyof T, P2 extends keyof T, P3 extends keyof T, P4 extends keyof T>(props: [P, P2, P3, P4], final?: boolean): Pick<T, P | P2 | P3 | P4>
