...
describe('Chart.helpers.options', function () {
  ...
  describe('toPadding', function () {
    it('should support number values', function () {
      expect(toPadding(4)).toEqual({ top: 4, right: 4, bottom: 4, left: 4, height: 8, width: 8 })
      expect(toPadding(4.5)).toEqual({ top: 4.5, right: 4.5, bottom: 4.5, left: 4.5, height: 9, width: 9 })
    })
    ...
    it('should support object values', function () {
      expect(toPadding({ top: 1, right: 2, bottom: 3, left: 4 })).toEqual({ top: 1, right: 2, bottom: 3, left: 4, height: 4, width: 6 })
      expect(toPadding({ top: 1.5, right: 2.5, bottom: 3.5, left: 4.5 })).toEqual({ top: 1.5, right: 2.5, bottom: 3.5, left: 4.5, height: 5, width: 7 })
      expect(toPadding({ top: '1', right: '2', bottom: '3', left: '4' })).toEqual({ top: 1, right: 2, bottom: 3, left: 4, height: 4, width: 6 })
    })
    it('should fallback to 0 for invalid values', function () {
      expect(toPadding({ top: 'foo', right: 'foo', bottom: 'foo', left: 'foo' })).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
      expect(toPadding({ top: null, right: null, bottom: null, left: null })).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
      expect(toPadding({})).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
      expect(toPadding('foo')).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
      expect(toPadding(null)).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
      expect(toPadding(undefined)).toEqual({ top: 0, right: 0, bottom: 0, left: 0, height: 0, width: 0 })
    })
  })
