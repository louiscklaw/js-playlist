...
module.exports = {
  someSidebar: {
    ...
    Axes: [
      'axes/index',
      { Cartesian: ['axes/cartesian/index', 'axes/cartesian/category', 'axes/cartesian/linear', 'axes/cartesian/logarithmic', 'axes/cartesian/time'] },
      { Radial: ['axes/radial/index', 'axes/radial/linear'] },
      'axes/labelling',
      'axes/styling',
    ],
    Developers: [
