...
!(function (e) {
  ...
  !(function (e) {
    ...
    ;(t.prototype = {
      cycle: function (t) {
        return (
          t || (this.paused = !1), this.options.interval && !this.paused && (this.interval = setInterval(e.proxy(this.next, this), this.options.interval)), this
        )
      },
      to: function (t) {
  ...
  !(function (e) {
    ...
    ;(n.prototype = {
      ...
      e(document)
        ...
        .on('click.dropdown.data-api touchstart.dropdown.data-api', t, n.prototype.toggle)
          ...
          !this.isShown && this.$backdrop
            ? (this.$backdrop.removeClass('in'),
              e.support.transition && this.$element.hasClass('fade')
                ? this.$backdrop.one(e.support.transition.end, e.proxy(this.removeBackdrop, this))
                : this.removeBackdrop())
            : t && t()
      },
    }),
