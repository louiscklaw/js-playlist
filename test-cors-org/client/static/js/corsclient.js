;(function (window, undefined) {
  ...
  var sendRequest = function (controller, url) {
    ...
    // Link to this test.
    logger.log(
      "<a href=\"#\" onclick=\"javascript:prompt('Here\\'s a link to this test', '" +
        htmlEscape(window.location.href) +
        '\');return false;">Link to this test</a><br>',
    )
    ...
    var msg = 'Sending ' + htmlEscape(httpMethod) + ' request to ' + '<code>' + htmlEscape(serverUrl) + '</code><br>'
