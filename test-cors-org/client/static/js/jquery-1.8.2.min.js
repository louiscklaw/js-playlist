  ...
  ;(p.fn = p.prototype =
    ...
    p.extend({
      ...
      makeArray: function (a, b) {
        ...
        return (
          a != null &&
            ((c = p.type(a)), a.length == null || c === 'string' || c === 'function' || c === 'regexp' || p.isWindow(a) ? j.call(d, a) : p.merge(d, a)),
          d
        )
      },
    ...
    (function (a, b) {
      ...
      var c,
        ...
        W = {
          ...
          POS: new RegExp(K, 'i'),
          CHILD: new RegExp(
            '^:(only|nth|first|last)-child(?:\\(' + E + '*(even|odd|(([+-]|)(\\d*)n|)' + E + '*(?:([+-]|)' + E + '*(\\d+)|))' + E + '*\\)|)',
            'i',
          ),
      ...
      ;(bc.matches = function (a, b) {
        ...
        (j = s.compareDocumentPosition
          ? function (a, b) {
              return a === b
                ? ((k = !0), 0)
                : (!a.compareDocumentPosition || !b.compareDocumentPosition ? a.compareDocumentPosition : a.compareDocumentPosition(b) & 4)
                ? -1
                : 1
            }
          : function (a, b) {
  ...
  p.fn.extend({
    ...
    p.expr &&
      ...
      ((p.expr.filters.hidden = function (a) {
        return (
          (a.offsetWidth === 0 && a.offsetHeight === 0) || (!p.support.reliableHiddenOffsets && ((a.style && a.style.display) || bH(a, 'display')) === 'none')
        )
      }),
